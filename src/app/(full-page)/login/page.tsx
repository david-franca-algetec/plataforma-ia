        ...
        >
          <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
            ...
            <div>
              ...
              <InputText id="email1" type="text" placeholder="Endereço de e-mail" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />

              <label htmlFor="password1" className="block text-900 font-medium text-xl mb-2">
                Senha
              </label>
              <Password inputId="password1" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Sua senha" toggleMask className="w-full mb-5" inputClassName="w-full p-3 md:w-30rem"></Password>
